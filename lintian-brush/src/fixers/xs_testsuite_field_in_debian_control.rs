...
pub fn run(base_path: &Path) -> Result<FixerResult, FixerError> {
    ...
    Ok(FixerResult::builder("Remove unnecessary XS-Testsuite field in debian/control.")
...
mod tests {
    ...
    fn test_xs_testsuite_autopkgtest_removed() {
        ...
        assert_eq!(result.description, "Remove unnecessary XS-Testsuite field in debian/control.");
