...
class NameListTests(TestCase):
    ...
    def test_some(self):
        ...
        self.assertEqual("bar and foo", name_list(["foo", "bar", "foo"]))
        self.assertEqual(
...
class FilterRelationsTests(TestCase):
    def test_missing(self):
        ...
        self.assertEqual([], filter_relations(control, "Build-Depends", None))  # type: ignore
    ...
    def test_drop_last(self):
        ...
        self.assertEqual(
            PkgRelation.parse("foo"), filter_relations(control, "Depends", cb)
        )
    ...
    def test_transition(self):
        ...
        self.assertEqual(
            (
                ...
                [
                    ReplaceTransition(
                        PkgRelation.parse("oldpackage (>= 1.0)")[0],
        ...
        self.assertEqual(
            (
                ...
                [
                    ...
                    ReplaceTransition(
                        PkgRelation.parse("oldpackage (= 3.0)")[0],
                        PkgRelation.parse("replacement"),
                    ),
                ],
            ),
